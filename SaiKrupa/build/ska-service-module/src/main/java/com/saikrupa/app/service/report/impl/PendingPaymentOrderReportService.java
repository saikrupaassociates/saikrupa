...
public class PendingPaymentOrderReportService extends AbstractReportService {
	
	private List<OrderData> orders;

	public PendingPaymentOrderReportService(List<OrderData> orders) {
		setOrders(orders);
	}
	...
	public void addMetaData(Document document) {
		document.addTitle("Order Report - Pending Payment");
		
	}

	@Override
	public String getPageTitle() {
		return "Order Report - Pending Payment";
	}
