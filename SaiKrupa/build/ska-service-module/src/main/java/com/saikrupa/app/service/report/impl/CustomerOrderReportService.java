...
public class CustomerOrderReportService extends AbstractReportService {
	...
	public void createPageTableContent(Document document) throws DocumentException {
		...
		ReportTableHeaderCell customerContact = new ReportTableHeaderCell("Phone Number");
		...
		ReportTableDataCell contactValue = new ReportTableDataCell(getOrders().get(0).getCustomer().getPrimaryContact(), CellValueType.TEXT, true);
