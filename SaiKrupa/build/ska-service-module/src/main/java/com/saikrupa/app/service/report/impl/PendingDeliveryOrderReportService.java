...
public class PendingDeliveryOrderReportService extends AbstractReportService {
	
	private List<OrderData> orders;

	public PendingDeliveryOrderReportService(List<OrderData> orders) {
		setOrders(orders);
	}
	...
	public void addMetaData(Document document) {
		document.addTitle("Order Report - Pending Delivery");
		
	}

	@Override
	public String getPageTitle() {
		return "Order Report - Pending Delivery";
	}
