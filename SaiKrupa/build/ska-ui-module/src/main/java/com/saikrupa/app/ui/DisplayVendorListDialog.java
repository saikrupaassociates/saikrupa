...
public class DisplayVendorListDialog extends BaseAppDialog {
	...
	public DisplayVendorListDialog(ManageExpenseDialog owner) {
		super(owner, true);
	...
	private void buildGUI(final ManageExpenseDialog owner) {
	...
	private void performSelectionOperation(WebTable vendorContentTable, ManageExpenseDialog owner) {
		...
		owner.getPaidToVendorText().setModel(data);
		owner.getPaidToVendorText().setText(data.getName());
	}
